          ...
          <div class="col-lg-6 hero-content">
            <div class="hero-badge">
              <span class="badge-icon" aria-hidden="true">
                <img src=\"assets/img/star.png" alt="" height="15" width="15" loading="eager">
              </span> 
            ...
            <div class="hero-actions d-flex gap-3">
              <a href="join.html" class="btn btn-primary-gradient btn-lg">
                Join Community
              </a>
              <a href="idea.html" class="btn btn-outline-light btn-lg">
                Share Your Ideas
              </a>
            </div>
          </div>
            ...
            <div class="hero-visual">
              ...
              <div class="glass-ui-card floating-card card-1">
                <div class="icon-box-sm">
                  <img src=\"assets/img/noto_fire.svg" alt="" srcset="" height="20px" width="20px">
                </div>
                <div>
        ...
        <div class="row g-4 mt-5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="about-card">
              <div class="icon-box">
                <img src=\"assets/img/paint.png" alt="Design icon" loading="lazy">
              </div>
              <h4>Design First</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="about-card">
              <div class="icon-box">
                <img src=\"assets/img/ar.png" alt="Code icon" loading="lazy">
              </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="about-card">
              <div class="icon-box">
                <img src=\"assets/img/id.png" alt="Innovation icon" loading="lazy">
              </div>
              <h4>Innovation</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="about-card">
              <div class="icon-box">
                <img src=\"assets/img/l.png" alt="Community icon" loading="lazy">
              </div>
              <h4>Community</h4>
      ...
      <div class="container text-center">
        ...
        <div class="row g-4 mt-5">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-card-v3">
              <div class="team-card-v3-img">
                <img src=\"assets/img/p1.png" alt="Aradhya Arya" />
              </div>
              ...
              <div class="team-card-v3-content">
                ...
                <div class="team-social-v3">
                   <a href="#" class="social-icon-box" aria-label="Visit Aradhya's LinkedIn profile">
                    <img src=\"assets/img/linked.svg" alt="LinkedIn" height="32" width="32" loading="lazy">
                   </a>
                   <a href="#" class="social-icon-box" aria-label="Visit Aradhya's Behance profile">
                    <img src=\"assets/img/behn.svg" alt="Behance" height="32" width="32" loading="lazy">
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="team-card-v3">
              <div class="team-card-v3-img">
                <img src=\"assets/img/p1.png" alt="Zula Prajapati" />
              </div>
              ...
              <div class="team-card-v3-content">
                ...
                <div class="team-social-v3">
                   <a href="#" class="social-icon-box" aria-label="LinkedIn">
                    <img src=\"assets/img/linked.svg" alt="" srcset="" height="32" width="32">
                   ...
                   <a href="#" class="social-icon-box" aria-label="Behance">
                    <img src=\"assets/img/behn.svg" alt="" srcset="" height="32" width="32">
                  </a>
                </div>
              </div>
            </div>
           ...
           <div class="col-lg-3 col-md-6">
            <div class="team-card-v3">
              <div class="team-card-v3-img">
                <img src=\"assets/img/p1.png" alt="Mohit Rana" />
              </div>
            ...
            <div class="team-card-v3">
              <div class="team-card-v3-img">
                <img src=\"assets/img/p1.png" alt="yugan" />
              </div>
           ...
           <div class="col-lg-3 col-md-6">
            <div class="team-card-v3">
              <div class="team-card-v3-img">
                <img src=\"assets/img/p1.png" alt="Rudra" />
              </div>
        ...
        <div class="row g-4 mt-5">
          ...
          <div class="col-lg-3 col-md-6">
            <article class="resource-card">
              <img src=\"assets/img/et.png" alt="UX Booklets preview" loading="lazy" />
          ...
          <div class="col-lg-3 col-md-6">
            <article class="resource-card">
              <img src=\"assets/img/et.png" alt="AI/ML Article preview" loading="lazy" />
          ...
          <div class="col-lg-3 col-md-6">
            <article class="resource-card">
              <img src=\"assets/img/et.png" alt="UXPacific Badges preview" loading="lazy" />
          ...
          <div class="col-lg-3 col-md-6">
            <article class="resource-card">
              <img src=\"assets/img/et.png" alt="Case Studies preview" loading="lazy" />
    ...
    <section class="events-section" id="event-section">
      ...
      <div id="upcoming-events-container">
        ...
        <article class="event-card">
          ...
          <div class="event-img">
            <img src=\"assets/img/et.png" alt="Design Systems Summit" />
          </div>
          ...
          <div class="event-body">
            ...
            <ul class="event-meta">
              <li>
                <img src=\"assets/img/Icon.png" alt="" height="15px" width="15px">
                 Nov 15, 2026 · 10:00 AM PST</li>
              <li>
                <img src=\"assets/img/Icon-1.png" alt="" height="15px" width="15px">
                Virtual</li>
              <li>
                <img src=\"assets/img/Icon-2.png" alt="" height="15px" width="15px">
                500+ attendees</li>
            </ul>
      ...
      <div id="past-events-container" style="display: none;">
        ...
        <article class="event-card past">
          ...
          <div class="event-img">
            <img src=\"assets/img/et.png" alt="Web3 Design Patterns" />
          </div>
          <div class="event-body">
        ...
        <div class="reviews-grid">
          ...
          <div class="review-card-set" id="original-cards">
            ...
            <div class="testimonial-card" style="background-color: #312e81">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Andrew Ajai Singh" src=\"assets/img/Oval (1).png" />
                </div>
            ...
            <div class="testimonial-card" style="background-color: #4338ca">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Dharmik Bhavsar" src=\"assets/img/Oval (2).png" />
                </div>
                <div class="author-info">
            ...
            <div class="testimonial-card" style="background-color: #4f46e5">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Diya Mehta" src="assets/img/DMDM.png" />
                </div>
                <div class="author-info">
            ...
            <div class="testimonial-card" style="background-color: #312e81">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Dr. Vishal Singh" src=\"assets/img/Oval.png" />
                </div>
                <div class="author-info">
            ...
            <div class="testimonial-card" style="background-color: #312e81">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Andrew Ajai Singh" src=\"assets/img/yuggie.png" />
                </div>
                <div class="author-info">
            ...
            <div class="testimonial-card" style="background-color: #312e81">
              ...
              <div class="author">
                <div class="avatar">
                  <img alt="Andrew Ajai Singh" src=\"assets/img/Devanshi.png" />
                </div>
                <div class="author-info">
