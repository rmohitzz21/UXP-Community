      ...
      <aside class="admin-sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
          <ul class="nav-list">
            ...
            <li class="nav-item">
              <a href="admin-registrations.html" class="nav-link">
                <i class="bi bi-person-check-fill"></i>
                <span>Registrations</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="admin-resources.html" class="nav-link">
          ...
          <div class="row g-4 mt-2">
            ...
            <div class="col-lg-8">
              <div class="admin-card">
                <div class="card-header">
                  ...
                  <a href="admin-contacts.html" class="btn btn-sm btn-outline-primary">
                    View All
                  </a>
                </div>
                <div class="card-body">
            ...
            <div class="col-lg-4">
              <div class="admin-card mb-4">
                ...
                <div class="card-body">
                  <div class="quick-actions">
                    <a href="admin-events.html" class="quick-action-btn">
                      <i class="bi bi-calendar-plus"></i>
                      <span>Add Event</span>
                    </a>
                    <a href="admin-resources.html" class="quick-action-btn">
                      <i class="bi bi-upload"></i>
                      <span>Upload Resource</span>
                    </a>
                    <a href="admin-members.html" class="quick-action-btn">
              ...
              <div class="admin-card">
                <div class="card-header">
                  <h2>New Members</h2>
                  <a href="admin-members.html" class="btn btn-sm btn-outline-primary">
                    View All
                  </a>
                </div>
                <div class="card-body">
            ...
            <div class="col-12">
              <div class="admin-card">
                <div class="card-header">
                  ...
                  <a href="admin-events.html" class="btn btn-sm btn-outline-primary">
                    Manage Events
                  </a>
                </div>
                <div class="card-body">
