            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="admin-table">
                  ...
                  <tbody>
                    <tr>
                      <td><i class="bi bi-file-pdf"></i> UX Best Practices.pdf</td>
                      <td><span class="badge-industry">Design</span></td>
                      <td>Mar 20, 2026</td>
                      <td>245</td>
                      <td>
                        <button class="btn-action" title="Download"><i class="bi bi-download"></i></button>
          ...
          <div class="modal-body">
            <form>
              <div class="mb-3">
                ...
                <input type="text" class="form-control" placeholder="Enter resource name" />
              </div>
              <div class="mb-3">
                <label class="form-label">Category</label>
                <select class="form-select">
                  <option value="" style="background: #1a1a2e; color: #6b6b80;">Select category</option>
                  <option value="design" style="background: #1a1a2e; color: #fff;">Design</option>
                  <option value="development" style="background: #1a1a2e; color: #fff;">Development</option>
                </select>
              </div>
              <div class="mb-3">
